...
def main():
    ...
    funk_src = os.path.join(root, "benchmarks", "bench", "fp_axpy_compare.f")
    py_src = os.path.join(root, "benchmarks", "bench", "fp_axpy_compare.py")
    c_src = os.path.join(root, "benchmarks", "bench", "fp_axpy_compare.c")
