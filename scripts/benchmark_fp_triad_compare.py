...
def main():
    ...
    funk_src = os.path.join(root, "benchs", "fp_triad_compare.f")
    py_src = os.path.join(root, "benchs", "fp_triad_compare.py")
    c_src = os.path.join(root, "benchs", "fp_triad_compare.c")
