...
def main():
    parser = argparse.ArgumentParser(
        description="Benchmark STREAM-like triad reduction across Funk/Python/C."
    )
    ...
    funk_src = os.path.join(root, "benchmarks", "bench", "fp_triad_compare.f")
    py_src = os.path.join(root, "benchmarks", "bench", "fp_triad_compare.py")
    c_src = os.path.join(root, "benchmarks", "bench", "fp_triad_compare.c")
