...
def main():
    parser = argparse.ArgumentParser(description="Benchmark mutual recursion across Funk/Python/C.")
    ...
    parser.add_argument("--backend", choices=["cpp20", "cpp20_i32"], default="cpp20_i32")
    args = parser.parse_args()

    root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    funk_src = os.path.join(root, "benchmarks", "bench", "mutual_recursion_compare.f")
    py_src = os.path.join(root, "benchmarks", "bench", "mutual_recursion_compare.py")
    c_src = os.path.join(root, "benchmarks", "bench", "mutual_recursion_compare.c")
    ...
    c_bin = os.path.join(build_dir, "mutual_recursion_compare_c")
    ...
    funk_bin = os.path.join(build_dir, "mutual_recursion_compare")
