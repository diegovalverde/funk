...
def main():
    ...
    funk_src = os.path.join(root, "benchs", "mutual_recursion_compare.f")
    py_src = os.path.join(root, "benchs", "mutual_recursion_compare.py")
    c_src = os.path.join(root, "benchs", "mutual_recursion_compare.c")
