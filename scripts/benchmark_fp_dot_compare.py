...
def main():
    parser = argparse.ArgumentParser(description="Benchmark floating-point dot across Funk/Python/C.")
    ...
    funk_src = os.path.join(root, "benchmarks", "bench", "fp_dot_compare.f")
    py_src = os.path.join(root, "benchmarks", "bench", "fp_dot_compare.py")
    c_src = os.path.join(root, "benchmarks", "bench", "fp_dot_compare.c")
    ...
    c_bin = os.path.join(build_dir, "fp_dot_compare_c")
    ...
    funk_bin = os.path.join(build_dir, "fp_dot_compare")
