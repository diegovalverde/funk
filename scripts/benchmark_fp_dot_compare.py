...
def main():
    ...
    funk_src = os.path.join(root, "examples", "bench", "fp_dot_compare.f")
    py_src = os.path.join(root, "examples", "bench", "fp_dot_compare.py")
    c_src = os.path.join(root, "examples", "bench", "fp_dot_compare.c")
