...
def main():
    ...
    funk_src = os.path.join(root, "examples", "bench", "concat_compare.f")
    py_src = os.path.join(root, "examples", "bench", "concat_compare.py")
    c_src = os.path.join(root, "examples", "bench", "concat_compare.c")
