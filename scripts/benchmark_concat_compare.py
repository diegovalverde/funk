...
def main():
    parser = argparse.ArgumentParser(description="Benchmark list-heavy concat workload across Funk/Python/C.")
    ...
    funk_src = os.path.join(root, "benchmarks", "bench", "concat_compare.f")
    py_src = os.path.join(root, "benchmarks", "bench", "concat_compare.py")
    c_src = os.path.join(root, "benchmarks", "bench", "concat_compare.c")
    ...
    c_bin = os.path.join(build_dir, "concat_compare_c")
    ...
    funk_bin = os.path.join(build_dir, "concat_compare")
