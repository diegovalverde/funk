...
def main():
    parser = argparse.ArgumentParser(description="Benchmark tail-recursive Fibonacci across Funk/Python/C.")
    ...
    funk_src = os.path.join(root, "benchs", "fib_tr_compare.f")
    py_src = os.path.join(root, "benchs", "fib_tr_compare.py")
    c_src = os.path.join(root, "benchs", "fib_tr_compare.c")
    ...
    funk_bin = os.path.join(build_dir, "fib_tr_compare")
