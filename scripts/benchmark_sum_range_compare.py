...
def main():
    ...
    funk_src = os.path.join(root, "benchs", "sum_range_compare.f")
    py_src = os.path.join(root, "benchs", "sum_range_compare.py")
    c_src = os.path.join(root, "benchs", "sum_range_compare.c")
