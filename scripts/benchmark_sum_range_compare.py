...
def main():
    parser = argparse.ArgumentParser(description="Benchmark sum_range across Funk/Python/C.")
    ...
    funk_src = os.path.join(root, "benchmarks", "bench", "sum_range_compare.f")
    py_src = os.path.join(root, "benchmarks", "bench", "sum_range_compare.py")
    c_src = os.path.join(root, "benchmarks", "bench", "sum_range_compare.c")
    ...
    c_bin = os.path.join(build_dir, "sum_range_compare_c")
    ...
    funk_bin = os.path.join(build_dir, "sum_range_compare")
