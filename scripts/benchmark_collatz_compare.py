...
def main():
    parser = argparse.ArgumentParser(description="Benchmark Collatz workload across Funk/Python/C.")
    ...
    funk_src = os.path.join(root, "examples", "bench", "collatz_compare.f")
    py_src = os.path.join(root, "examples", "bench", "collatz_compare.py")
    c_src = os.path.join(root, "examples", "bench", "collatz_compare.c")
